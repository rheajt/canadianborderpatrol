  ...
  const links = [
    {
      text: 'iTunes',
      href:
        'https://podcasts.apple.com/ca/podcast/canadian-border-patrol/id1463751515',
      icon: iTunesNoteIcon,
    },
    {
      text: 'Google Play',
      href:
        'https://play.google.com/music/listen?u=0#/ps/Ijfvdnyyavpl4jo4witxkakz5f4',
      icon: googlePlayIcon,
    },
    {
      text: 'Stitcher',
      href:
        'https://www.stitcher.com/podcast/canadian-border-patrol?refid=stpr',
      icon: stitcherIcon,
    },
    {
      text: 'RSS',
  ...
  return (
    ...
    >
      {links.map((link, index, array) => {
        return (
          <Button bg="flagred" m={1} key={link.href}>
